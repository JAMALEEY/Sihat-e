...
import { logout, createTension, fetchTensionInfos, editTension, deleteTension } from "../../../../actions";
 ...
 <div class="login-box-seperator" id="login-box-seperator-left"></div>
                    <div id='taillemetricyourmetric'>
                        <div>
                            ...
                            <p>
                            au : {thetensionData.date}
                            </p>
                            </strong>
 
          {/* {this.upd = (formValues) => {this.props.editTaille(thepoidsData.id, formValues)}} */}
        {/* Updtae */}
        { this.editTension = (formValues) => this.props.editTension(thetensionData.id, formValues)} 

        <ModalUpdate edit={this.props.handleSubmit(this.editTension)} id={this.state.id} date={this.state.date} mesures={this.state.mesures} modalTitle={this.state.modalTitleEdit} show2={this.state.show2} handleClose={this.hideModal}>

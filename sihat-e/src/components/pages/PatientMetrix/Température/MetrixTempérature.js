...
class MetrixTemperature extends Component {
  ...
  renderList() {
    if (
      !this.props.temperatureData.temperature_reducer.temperature.historique
    ) {
      <Loader />;
    } else if (
      this.props.temperatureData.temperature_reducer.temperature.historique
      ...
      return this.props.temperatureData.temperature_reducer.temperature.historique.map(
        (thetemperatureData) => {
          return (
            <div key={thetemperatureData.id}>
              ...
              <div id="taillemetricyourmetric">
                <div>
                  ...
                  <strong>
                    <p>au : {thetemperatureData.date}</p>
                  </strong>

                  {/* {this.upd = (formValues) => {this.props.editTaille(theglucoseData.id, formValues)}} */}
                  {/* Creat */}
                  {
                    (this.editTemperature = (formValues) =>
                      this.props.editTemperature(
                        thetemperatureData.id,
                        formValues
                      ))
                  }

                  <ModalUpdate
                    edit={this.props.handleSubmit(this.editTemperature)}
                ...
                <div>
                  <div className="dropdown">
                    ...
                    >
                      {
                        (this.del = () =>
                          this.props.deleteTemperature(thetemperatureData.id))
                      }
                ...
                <div id="formCardContainer">
                  <div>
                    ...
                    <div className="metrixWrapper">
                      <Modal
                        submit={this.props.handleSubmit(this.createTemperature)}
                      ...
                      <Link onClick={this.showModalCreate} className="fasflex">
                        <p>Ajouter Votre Température</p>
                        <i className="fas fa-plus fa-2x"></i>
                      </Link>
                      <div id="taillemetricyourmetric">
                        <div>
                          <h5>Température la plus récente :</h5>
                        </div>
                        <div>
                          <h3>
                            <strong>

...
import { logout, createGlucose, fetchGlucoseInfos, editGlucose, deleteGlucose } from "../../../../actions";
...
class MetrixGlucose extends Component {
  ...
  renderList() {  
    ...
    return this.props.glucoseData.glucose_reducer.glucose.historique
    .map(theglucoseData => {
      return (
 ...
 <div class="login-box-seperator" id="login-box-seperator-left"></div>
                    <div id='taillemetricyourmetric'>
                        <div>
                            ...
                            <p>
                            au : {theglucoseData.date}
                            </p>
                            </strong>
 
          {/* {this.upd = (formValues) => {this.props.editTaille(theglucoseData.id, formValues)}} */}
        {/* Creat */}
        { this.editGlucose = (formValues) => this.props.editGlucose(theglucoseData.id, formValues)} 
      ...
      { this.del = () => this.props.deleteGlucose(theglucoseData.id)} 

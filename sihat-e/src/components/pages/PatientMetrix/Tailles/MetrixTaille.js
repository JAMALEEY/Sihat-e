...
class MetrixTaille extends Component {
  ...
  renderList() {
    if (!this.props.tailleData.tailles_reducer.tailles.historique) {
      ...
      return this.props.tailleData.tailles_reducer.tailles.historique.map(
        (thetailleData) => {
          return (
            <div key={thetailleData.id}>
              ...
              <div id="taillemetricyourmetric">
                <div>
                  ...
                  <p>
                    <strong>Ma taille est de : {thetailleData.cm} cm</strong>
                  </p>
                  <strong>
                    <p>au : {thetailleData.date}</p>
                  </strong>

                  {/* {this.upd = (formValues) => {this.props.editTaille(thetailleData.id, formValues)}} */}
                  {/* Creat */}
                  {
                    (this.editTaille = (formValues) =>
                      this.props.editTaille(thetailleData.id, formValues))
                  }

                  <ModalUpdate
                    edit={this.props.handleSubmit(this.editTaille)}
                    id={this.state.id}
        ...
        // onDismiss={() => history.push('/')} */}
                      ...
                      {
                        (this.del = () =>
                          this.props.deleteTaille(thetailleData.id))
                      }
  ...
  render() {
                ...
                <div id="formCardContainer">
                  <div>
                    ...
                    <div className="metrixWrapper">
                      <Modal
                        submit={this.props.handleSubmit(this.creatTaille)}
    ...
    ?  this.props.tailleData.tailles_reducer.tailles.last_height.cm : 'Data failed'} */}
                              {!this.props.tailleData.tailles_reducer
                                .recievedData
                                ? " _ "
                                : this.props.tailleData.tailles_reducer.tailles
                                    .last_height === undefined
                                ? " _ "
    ...
    ?  this.props.tailleData.tailles_reducer.tailles.last_height.date : 'Data failed'} */}
                            {!this.props.tailleData.tailles_reducer.recievedData
                              ...
                              : this.props.tailleData.tailles_reducer.tailles
                                  .last_height === undefined
                              ? " _ "
                              : ` ${this.props.tailleData.tailles_reducer.tailles.last_height.date}  `}
                          </p>
                        </div>
                      </div>
